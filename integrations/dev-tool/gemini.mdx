...
$env:GEMINI_BASE_URL = "https://claw.dualseason.com/v1"
```
...
export GEMINI_BASE_URL="https://claw.dualseason.com/v1"
```
...
[System.Environment]::SetEnvironmentVariable('GEMINI_BASE_URL', 'https://claw.dualseason.com/v1', 'User')
```
...
GEMINI_BASE_URL=https://claw.dualseason.com/v1
```
...
<Note>
  **重要提示：** - 将 `sk-xxxxxxxxxxxx` 替换为您从 [APIMart 控制台](https://claw.dualseason.com/console/token) 获取的实际 API 密钥 - `GEMINI_BASE_URL` 设置为
  `https://claw.dualseason.com/v1`，确保 Gemini CLI 连接到 APIMart - 如果使用 `.env` 文件，请将其添加到 `.gitignore` 避免泄露 API 密钥
</Note>
...
openai.api_base = "https://claw.dualseason.com/v1"
...
```bash theme={null}
curl https://claw.dualseason.com/v1/chat/completions \
