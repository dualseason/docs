...
| 模型类型 | 服务商类型 | Base URL |
| --- | --- | --- |
| GPT Responses | `OpenAI Responses` | `https://api.xcompute.us/v1` |
| GPT Chat Completions | `Chat Completions` | `https://api.xcompute.us/v1` |
| Claude | `Anthropic Messages` | `https://api.xcompute.us` |
...
| Base URL | `https://api.xcompute.us` |
| API Key | Xcompute API Key |
