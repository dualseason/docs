...
<RequestExample>
  ...
  curl --request POST \
    --url https://claw.dualseason.com/v1beta/models/gemini-2.5-pro:generateContent \
  ...
  const url = "https://claw.dualseason.com/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://claw.dualseason.com/v1beta/models/gemini-2.5-pro:generateContent";
  ...
  url = URI("https://claw.dualseason.com/v1beta/models/gemini-2.5-pro:generateContent")
