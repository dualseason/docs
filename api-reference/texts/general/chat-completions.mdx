...
<RequestExample>
  ...
  curl --request POST \
    --url https://claw.dualseason.com/v1/chat/completions \
  ...
  const url = "https://claw.dualseason.com/v1/chat/completions";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://claw.dualseason.com/v1/chat/completions";
  ...
  url = URI("https://claw.dualseason.com/v1/chat/completions")
  ...
  let url = URL(string: "https://claw.dualseason.com/v1/chat/completions")!
  ...
  class Program
  {
      ...
      {
          var url = "https://claw.dualseason.com/v1/chat/completions";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://claw.dualseason.com/v1/chat/completions";
          // 可替换为任意支持的模型 ID
          const char *payload = "{"
              "\"model\":\"gpt-4o\","
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://claw.dualseason.com/v1/chat/completions"];
  ...
  let url = "https://claw.dualseason.com/v1/chat/completions"
  ...
  void main() async {
    final url = Uri.parse('https://claw.dualseason.com/v1/chat/completions');
