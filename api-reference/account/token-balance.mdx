...
<RequestExample>
  ...
  curl --request GET \
    --url 'https://claw.dualseason.com/v1/balance' \
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://claw.dualseason.com/v1/balance";
  ...
  $ch = curl_init('https://claw.dualseason.com/v1/balance');
  ...
  url = URI("https://claw.dualseason.com/v1/balance")
  ...
  let url = URL(string: "https://claw.dualseason.com/v1/balance")!
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var url = "https://claw.dualseason.com/v1/balance";
