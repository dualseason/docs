...
<RequestExample>
  ...
  curl --request GET \
    --url 'https://claw.dualseason.com/v1/user/balance' \
  ...
  API_BASE = 'https://claw.dualseason.com'
  ...
  const API_BASE = 'https://claw.dualseason.com';
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://claw.dualseason.com/v1/user/balance";
  ...
  $ch = curl_init('https://claw.dualseason.com/v1/user/balance');
  ...
  url = URI("https://claw.dualseason.com/v1/user/balance")
  ...
  let url = URL(string: "https://claw.dualseason.com/v1/user/balance")!
  ...
  class Program
  {
      static async Task Main(string[] args)
      {
          ...
          var url = "https://claw.dualseason.com/v1/user/balance";
