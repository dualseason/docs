...
| `veo-3.1-generate-preview` | Veo 3.1 高质量视频生成 |
| `veo-3.1-fast-generate-preview` | Veo 3.1 快速视频生成 |
...
| `sora-2-pro` | `4`、`8` 或 `12` 秒 | 支持横向和纵向尺寸；使用 `resolution` 时填写 `720p` | 支持参考图片，不支持参考视频或音频 |
