...
<RequestExample>
  ...
  const url = "https://claw.dualseason.com/v1/videos/generations";
  ...
  public class Main {
      public static void main(String[] args) throws Exception {
          String url = "https://claw.dualseason.com/v1/videos/generations";
  ...
  url = URI("https://claw.dualseason.com/v1/videos/generations")
  ...
  let url = URL(string: "https://claw.dualseason.com/v1/videos/generations")!
  ...
  class Program
  {
      ...
      {
          var url = "https://claw.dualseason.com/v1/videos/generations";
  ...
  int main(void) {
      ...
      if(curl) {
          const char *url = "https://claw.dualseason.com/v1/videos/generations";
          const char *payload = "{"
              "\"model\":\"sora-2\","
              "\"prompt\":\"瀑布倾泻而下形成彩虹\","
              "\"duration\":8,"
  ...
  int main(int argc, const char * argv[]) {
      @autoreleasepool {
          NSURL *url = [NSURL URLWithString:@"https://claw.dualseason.com/v1/videos/generations"];
  ...
  let url = "https://claw.dualseason.com/v1/videos/generations"
  ...
  void main() async {
    final url = Uri.parse('https://claw.dualseason.com/v1/videos/generations');
...
<ParamField body="aspect_ratio" type="string" default="16:9">
  ...
  <Warning>当传入 `image_urls`（图生视频）时，`aspect_ratio` 参数失效，无需上传；视频方向将依据参考图自动判定。</Warning>
</ParamField>
