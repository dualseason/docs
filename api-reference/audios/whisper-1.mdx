> ## Documentation Index
>
> Fetch the complete documentation index at: [https://docs.apimart.ai/llms.txt](https://docs.apimart.ai/llms.txt) Use this file to discover all available pages before exploring further.
...
<ParamField body="model" default="whisper-1" type="string" required>
  语音识别模型名称
...
<ParamField body="response_format" default="json" type="string">
  输出格式
...
<ParamField body="temperature" default="0" type="number">
  采样温度，范围 0 到 1
