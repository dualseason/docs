...
| 模型 | 特点 | 适用场景 |
| --- | --- | --- |
| `claude-sonnet-4-5-20250929` | 速度与质量平衡 | 日常开发推荐 |
| `claude-opus-4-1-20250805` | 最强推理能力 | 复杂架构、疑难 bug |
| `claude-haiku-4-5-20251001` | 轻量快速 | 快速问答
...
alias cc-opus='claude --model claude-opus-4-1-20250805'
alias cc-quick='claude --model claude-haiku-4-5-20251001'
```
...
```bash
# 1. 确认模型名称完整
echo $ANTHROPIC_MODEL   # 应包含完整日期，如 claude-sonnet-4-5-20250929
...
| 模型 | `ANTHROPIC_MODEL` | `claude config set model` | `claude-sonnet-4-5-20250929` |
