---
title: "Node.js 开发环境准备"
description: "在 Windows、macOS 和 Linux 上安装 NVM、Node.js 与 npm，为编程 Agent 准备运行环境。"
---
...
<Columns cols={2}>
  <Card title="OpenCode 接入 Xcompute（推荐）" icon="code" href="/opencode">
