---
title: "热门模型使用快速接入"
description: "快速接入 gpt-image-2、veo3.1_fast 和 doubao-seedance-2-0，包含请求示例、参数说明与任务查询方式。"
---
...
`gpt-image-2` 是异步图像生成模型。提交任务后，你需要通过 `/v1/tasks/{task_id}` 查询结果。
...
| 参数 | 类型 | 是否必填 | 说明 |
| --- | --- | --- | --- |
| `model` | string | 是 | 固定填写 `gpt-image-2` |
